...
type GameServiceClient interface {
	StartGame(ctx context.Context, in *UserIDList, opts ...grpc.CallOption) (*MatchID, error)
}
...
func (c *gameServiceClient) StartGame(ctx context.Context, in *UserIDList, opts ...grpc.CallOption) (*MatchID, error) {
	out := new(MatchID)
...
type GameServiceServer interface {
	StartGame(context.Context, *UserIDList) (*MatchID, error)
...
func (UnimplementedGameServiceServer) StartGame(context.Context, *UserIDList) (*MatchID, error) {
